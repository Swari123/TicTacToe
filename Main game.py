...
turn = "X"
def printRules():
    print("""X starts first then alternates, click on a section in the game to place your marker""")
...
HelpMenu.add_command(label = "Instructions/rules", command = printRules)
